...
BundleAdjustmentModel(problem::NamedTuple; T::Type = Float64) = BundleAdjustmentModel(problem[1], problem[2]; T = T)

BundleAdjustmentModel(problem::DataFrameRow; T::Type = Float64) = BundleAdjustmentModel(copy(problem); T = T)
